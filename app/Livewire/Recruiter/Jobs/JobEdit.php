...
#[Layout('components.layouts.recruiter', ['pageTitle' => 'Edit Job'])]
class JobEdit extends Component
{
    ...
    public function mount(JobPosting $job): void
    {
        ...
        $this->job = $job;
        $this->wasApproved = $job->admin_approved;
    ...
    public function save(): void
    {
        ...
        $msg = $this->wasApproved
            ? 'Job updated. Re-submitted for admin approval.'
    ...
    {
        return view('livewire.recruiter.jobs.job-edit', [
